...
export default function About(){
    return(
        ...
        className="w-full my-10 mx-auto max-w-[90rem]  ">
           ...
           <h2 id="title" className="text-center mb-5  text-5xl">Experimente uma <span className="text-[#FFC90D]">ferramenta</span></h2>
            ...
            <article className='w-full my-20   max-w-[90rem]  px-7'>
                ...
                <div className='grid-flow-row-dense shadow-lg    items-center  justify-center  w-full grid grid-cols-3 rounded-lg'>
                    
                    <div className="p-10 rounded-l-lg content-center bg-[#FFC90D] h-full">
                     <div className=' my-9  '>
                         <h2 className="text-5xl text-[#0D0C22] leading-tight font-bold">Lojas de Conveniências</h2>
