...
export default function Banner(){
  ...
  <span className="relative inline-flex rounded-full h-5 w-5 bg-[#DD1D21]"></span>
            ...
            <h1 className="md:text-7xl text-2xl  text-wrap md:max-w-6xl  text-center md:leading-[76px] font-extrabold text-[#0D0C22]" 
            
            >Inovação que transforma suas tarefas em <span 
            
            className='    text-[#FF0000] '>segundos</span></h1>
            <p className='text-[#7f8792] text-center font-medium md:leading-9 text-wrap text-[17px] md:text-[20px]'>Explore gratuitamente todas as <br/>ferramentas para gerenciar o seu negócio.</p>
